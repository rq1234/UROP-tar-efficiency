...
| 5.1a/b | ATHEX under global vs Greek CCI. NOTE: 5.1a is currently full-sample (88%); the review recommends a matched-window version (83%) | P1 |
| 5.2a/b | BIST 100 under global (full sample) vs Turkish CCI | P2 |
