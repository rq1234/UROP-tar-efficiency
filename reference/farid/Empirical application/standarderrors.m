function [parameters] = standarderrors(c1,y,z)
...
range = linspace(-0.10,0.10,val); %this declares the range in which we look for the second and third parameter values
